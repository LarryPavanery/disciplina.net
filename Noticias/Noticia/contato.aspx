...
<%@ Page Title="Noticias" Language="C#" AutoEventWireup="true"
 CodeBehind="contato.aspx.cs" Inherits="Noticia.contato" MasterPageFile="~/master.master" %>

<asp:Content ID="contatoContent" ContentPlaceHolderID="ApplicationMain" runat="server">
 ...
 <!-- Page Header -->
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>Contato</h1>
                        <hr class="small">
                        <span class="subheading">Alguma sugestão? envie-nos!</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <p>Quer dividir algo conosco? Envie-nos uma mensagem e no máximo em 24h estaremos respondendo.</p>
                ...
                <form name="sentMessage" id="contactForm" novalidate>
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-12 floating-label-form-group controls">
                            ...
                            <input type="tel" class="form-control" placeholder="Numero de telefone" id="phone" required data-validation-required-message="Please enter your phone number.">
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <div class="row control-group">
